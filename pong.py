...
# Sprite Classes(A sprite is a computer graphics term for any object on the screen that can move around.)
# For example, the paddles and the pong ball.
...
# Sprite Creation.(This section creates the movable items in the game)
...
# Group of Sprites.(This part groups all our movable objects together)

all_sprites = pygame.sprite.Group()
all_sprites.add(paddle1, paddle2, pong)

# Screen update function.(We update the screen everytime our objects move)
